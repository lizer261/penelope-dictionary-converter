**Note**: This wiki has been copied from
http://code.google.com/p/babiloo/wiki/StarDict_format
with the permission of the _babiloo_ owner. Links in this version have been
updated to the current locations. The contact information at the end has also
been removed, otherwise this document is still the same as the original.


# Format for StarDict dictionary files #
Extracted from the [3.0.0 source code](http://stardict-3.googlecode.com/files/stardict-3.0.0.tar.bz2)

---



StarDict homepage: http://code.google.com/p/stardict-3/
...
After you have build a dictionary, you can use "stardict\_verify" to verify the
dictionary files. You can find it at "src/tools/".


**Note**: original contact information from the source-wiki has been removed as
it does not apply to this page in the current location. Please check out
http://code.google.com/p/babiloo/wiki/StarDict_format for more information.
Also note that permission from the _babiloo_ owner has been granted to copy
the wiki-page.

<a href='Hidden comment: 
this is the original contact information/credits that i took liberty to remove,
